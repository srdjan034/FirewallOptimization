...
public class FirewallIgniteIslandModel 
{
	...
	public static class IslandCallable implements IgniteCallable<NondominatedPopulation> {
		...
		public NondominatedPopulation call() throws Exception {
			...
			PeriodicAction migrationAction = new PeriodicAction(algorithm, 10000, FrequencyType.EVALUATIONS) {
			...
			while (migrationAction.getNumberOfEvaluations() < 1000000) {
	...
	public static void main(String[] args) throws IOException, InterruptedException 
	{
		try (Ignite ignite = Ignition.start("config/example-ignite.xml")) 
		{
			...
			new Plot()
			.add("Island Model", combined).show();
		}
	}
